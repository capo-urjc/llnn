...
def get_args():
    ...
    parser.add_argument('--batch-size', '-bs', type=int, default=2*1024, help='batch size (default: 128)')
    ...
    parser.add_argument('--epochs', '-e', type=int, default=3, help='Number of training epochs (default: 100)')
    ...
    parser.add_argument('--luts_per_layer', '-k', nargs='*', type=int, default=[2000, 2000], help='LUTs per layer (default: 2000)')
